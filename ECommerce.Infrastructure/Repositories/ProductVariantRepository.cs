...
namespace ECommerce.Infrastructure.Repositories
{
    public class ProductVariantRepository : IProductVariantRepository
    {
        ...
        public async Task<IEnumerable<ProductVariant>> GetByProductIdAsync(int productId)
        {
            ...
            using var connection = new SqlConnection(_connectionString);
            await connection.OpenAsync();
            var command = new SqlCommand("SELECT * FROM ProductVariants WHERE ProductId = @ProductId", connection);
        ...
        public async Task AddAsync(ProductVariant entity)
        {
            ...
            var command = new SqlCommand(
                ...
                "OUTPUT INSERTED.Id VALUES (@ProductId, @Size, @Color, @Price, @Stock)", connection);
        ...
        public async Task DeleteByProductIdAsync(int productId)
        {
            using var connection = new SqlConnection(_connectionString);
            await connection.OpenAsync();
            var command = new SqlCommand("DELETE FROM ProductVariants WHERE ProductId = @ProductId", connection);
            command.Parameters.AddWithValue("@ProductId", productId);
